...
if __name__ == '__main__':
    input = cv2.cvtColor(cv2.imread("../ED/Thermal/groundtruth/img_2.jpg"), cv2.COLOR_BGR2GRAY)
    edgemap = detect(input, nbitplanes=3, beta=0.0, winsize=2, sigma=1.0, kernelsize=5, use_gaussian=False)
